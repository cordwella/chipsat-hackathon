...
from adafruit_bus_device.i2c_device import I2CDevice			# Module for I2C
import time
import busio
import board
...
i2c_device = I2CDevice(i2c_bus, I2C_ADDR)						# Indicates /dev/i2c-1


# ---- Low level functions -----


def _read_u8(command):
...
def writeReg(addr,data):
    ...
    # Send the virtual register address (setting bit 7 to indicate a pending write).
    __write_u8(WRITE_REG, (addr | 0x80))
    while True:
